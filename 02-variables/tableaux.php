    ...
    <main class="container bg-white text-dark mb-5">
        <div class="row">
            <div class="col-sm-12 ">
                ...
                <p>Un tableau appelé array en anglais est une variable améliorée dans laquelle on stocke une multitude de valeurs. Ces valeurs peuvent être de n'importe quel type. Elle possedent un indice dont la numérotation commence à 0.
                <p>
                <blockquote>
