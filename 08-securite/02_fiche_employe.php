...
// voici la condition d'execution si la page recoit bien un id_employés
...
if (!empty( $_POST )) {
    ...
    header( 'location:02_employes.php'); // RETOUR A cette page
    exit(); // fin de script
} // fin du if empty
?> 
                    ...
                    <div class="col-sm-6 p-4 text-center m-auto">
                        ...
                        <form method="POST" action="" class="p-5 m-2">
                            <div class="form-group">
                                ...
                                <!-- on indique la valeur de l'input pour envoyer la bonne info -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- ?? est un if isset $fiche['nom'] affiche le, sinon '' chaine de caractere vide -->
                            ...
                            <div class="form-group">
                                <label for="sexe">Sexe : </label>
                                <!-- Pour les boutons radio, le 1er bouton sera checked et le second le sera si on a l'info du sexe et si cette info est égale à m-->
                                <div class="form-check form-check-inline">
                            ...
                            <div class="form-group">
                                ...
                                <!-- introduire une fonction pour formater l'affichage des nombre 1 200, 00 euros -->
                                <input type="text" class="form-control text-right" name="salaire" id="salaire" value="<?php echo number_format($fiche['salaire'], 2, ',', ' '). " €"; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="service" name="service" class="form-control text-right">
                                    <option value="commercial" <?php if (!(strcmp( "commercial", $fiche[ 'service' ]))) {echo "selected";} ?>> Commercial</option> <!-- strcmp = string comparaison -->
                    ...
                    <div class="col-sm-6 m-auto">
                        <div class="card text-center m-auto alert alert-danger border border-danger" style="width: 18rem;">
                            ...
                            <ul class="list-group list-group-flush border border-danger ">
                                ...
                                echo "Salaire : ".number_format($fiche['salaire'], 2, ',', ' '). " €";
                                ?> 
                                </li>
                            </ul>
                             <button type="button" class="btn btn-small btn-warning border border-danger"><a href="02_employes_supprimer.php">Licencier</a></button>
                        </div>
                    </div>
                </div> <!--fin de row-->
